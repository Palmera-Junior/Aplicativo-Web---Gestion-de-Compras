...
/**
 * Contrato de servicio para el envío de notificaciones por correo electrónico mediante Amazon SES.
 */
public interface IEmailService {
     ...
     * 
     * A dónde apunta:
        * - Amazon SES API v2, configurado mediante variables de entorno AWS.
     * 
     ...
     * @param pdf Arreglo de bytes con el documento PDF de la orden.
        * @throws Exception Si ocurre un fallo en SES o en el armado del mensaje MIME.
     */
